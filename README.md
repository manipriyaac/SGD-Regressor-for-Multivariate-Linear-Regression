...
2.Standardize the input features and target values using StandardScaler.
3.Train the MultiOutputRegressor with SGDRegressor and also train LinearRegression and SGDRegressor models.
4.Predict the outputs on the test data and convert the scaled predictions back to their original values.
5.Evaluate the models using Mean Squared Error (MSE) and compare the predicted results with the actual values.
...
## Output:
<img width="1087" height="475" alt="Screenshot 2026-07-25 091043" src="https://github.com/user-attachments/assets/478573a2-5a6d-49f5-a696-0baeade17943" />

<img width="740" height="806" alt="image" src="https://github.com/user-attachments/assets/ca7d51ce-639a-41d6-a1b8-f93f5e95995f" />
